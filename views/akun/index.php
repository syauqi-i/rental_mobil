	                 				...
	                 				<tbody>
										<?php while($akun = $data_akun->fetch_object()) : ?>
											<tr>
												...
												<td><?= $akun->username ?></td>
												<td>
													<a href="<?= base_url('akun/detail/' . $akun->id) ?>" class="btn btn-sm btn-warning"><i class="fa fa-eye"></i> Detail</a>						<a href="<?= base_url('akun/mfa/' . $akun->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-shield-alt"></i> MFA</a>													<a href="<?= base_url('akun/hapus/' . $akun->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
												</td>
											</tr>
										<?php endwhile; ?>
									</tbody>
